...
SECRET_KEY = "wk!d9*b#f^j+qy#7kr)e96nd8u6-*jm_+htd7efm*umengkt*8"
...
CORS_ORIGIN_WHITELIST = (
    "localhost:3000",  # everything from localhost:3000 is allowed to access our api via CorsMiddleware
)
